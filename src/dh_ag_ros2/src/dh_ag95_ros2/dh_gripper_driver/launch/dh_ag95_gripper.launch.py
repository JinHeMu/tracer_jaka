...
def generate_launch_description():
    ...
    urdf = os.path.join(get_package_share_directory('dh_ag_95'), 'urdf', 'dh_ag_95.urdf')
    robot_description = {'robot_description': open(urdf, 'r').read()}
