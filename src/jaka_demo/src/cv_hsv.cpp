...
static int iLowH = 0;
static int iHighH = 92;

static int iLowS = 89; 
static int iHighS = 255;

static int iLowV = 170;
...
int main(int argc, char **argv)
{
    ...
    //ros::Subscriber rgb_sub = nh.subscribe("/kinect2/sd/image_ir_rect", 1 , Cam_RGB_Callback);
    ros::Rate loop_rate(30);

    namedWindow("Threshold", WINDOW_AUTOSIZE);    //生成图像显示和参数调节的窗口空见
